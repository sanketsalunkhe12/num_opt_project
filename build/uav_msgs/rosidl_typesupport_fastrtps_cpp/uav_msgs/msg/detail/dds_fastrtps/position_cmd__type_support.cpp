...
#include "uav_msgs/msg/detail/position_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = uav_msgs::msg::PositionCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const uav_msgs::msg::PositionCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uav_msgs::msg::PositionCmd *>(
    untyped_ros_message);
...
static size_t _PositionCmd__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_PositionCmd(full_bounded, is_plain, 0);
...
{
  return &uav_msgs::msg::typesupport_fastrtps_cpp::_PositionCmd__handle;
}
