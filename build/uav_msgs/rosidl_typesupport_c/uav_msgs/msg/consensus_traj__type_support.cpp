...
static const _ConsensusTraj_type_support_symbol_names_t _ConsensusTraj_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, uav_msgs, msg, ConsensusTraj)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, uav_msgs, msg, ConsensusTraj)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, uav_msgs, msg, ConsensusTraj)() {
  return &::uav_msgs::msg::rosidl_typesupport_c::ConsensusTraj_message_type_support_handle;
}
