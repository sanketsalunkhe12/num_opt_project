...
#include "uav_msgs/msg/detail/position_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _PositionCmd__ros_msg_type = uav_msgs__msg__PositionCmd;
...
static uint32_t _PositionCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_uav_msgs__msg__PositionCmd(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = uav_msgs__msg__PositionCmd;
    is_plain =
      (
...
static size_t _PositionCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_uav_msgs__msg__PositionCmd(
