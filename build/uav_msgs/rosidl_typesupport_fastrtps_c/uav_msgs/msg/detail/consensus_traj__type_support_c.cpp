...
#include "uav_msgs/msg/detail/consensus_traj__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // bern_coeffs, waypoints
#include "geometry_msgs/msg/detail/vector3__functions.h"  // acceleration_max, acceleration_min, velocity_max, velocity_min
#include "std_msgs/msg/detail/header__functions.h"  // header
#include "std_msgs/msg/detail/string__functions.h"  // robot_name
...
using _ConsensusTraj__ros_msg_type = uav_msgs__msg__ConsensusTraj;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ConsensusTraj__ros_msg_type * ros_message = static_cast<const _ConsensusTraj__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: bern_coeffs
  {
    ...
    auto array_ptr = ros_message->bern_coeffs.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
  ...
  // Field name: velocity_max
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->velocity_max, cdr))
    {
      return false;
    }
  }

  // Field name: acceleration_min
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->acceleration_min, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: acceleration_max
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->acceleration_max, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  _ConsensusTraj__ros_msg_type * ros_message = static_cast<_ConsensusTraj__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: bern_coeffs
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->bern_coeffs.data) {
      geometry_msgs__msg__Point__Sequence__fini(&ros_message->bern_coeffs);
    }
    if (!geometry_msgs__msg__Point__Sequence__init(&ros_message->bern_coeffs, size)) {
      fprintf(stderr, "failed to create array for field 'bern_coeffs'");
      return false;
    }
    auto array_ptr = ros_message->bern_coeffs.data;
    for (size_t i = 0; i < size; ++i) {
...
static uint32_t _ConsensusTraj__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_uav_msgs__msg__ConsensusTraj(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = uav_msgs__msg__ConsensusTraj;
    is_plain =
      (
...
static size_t _ConsensusTraj__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_uav_msgs__msg__ConsensusTraj(
...
static message_type_support_callbacks_t __callbacks_ConsensusTraj = {
  "uav_msgs::msg",
  "ConsensusTraj",
...
static rosidl_message_type_support_t _ConsensusTraj__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ConsensusTraj,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, uav_msgs, msg, ConsensusTraj)() {
  return &_ConsensusTraj__type_support;
}
