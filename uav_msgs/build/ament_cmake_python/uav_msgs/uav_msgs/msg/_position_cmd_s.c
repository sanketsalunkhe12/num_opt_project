...
bool uav_msgs__msg__position_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uav_msgs.msg._position_cmd.PositionCmd", full_classname_dest, 38) == 0);
  }
  uav_msgs__msg__PositionCmd * ros_message = _ros_message;
  {  // header
...
PyObject * uav_msgs__msg__position_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("uav_msgs.msg._position_cmd");
