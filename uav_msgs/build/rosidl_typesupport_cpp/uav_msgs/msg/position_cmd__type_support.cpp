...
static const _PositionCmd_type_support_symbol_names_t _PositionCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uav_msgs, msg, PositionCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, uav_msgs, msg, PositionCmd)),
  }
};
...
get_message_type_support_handle<uav_msgs::msg::PositionCmd>()
{
  return &::uav_msgs::msg::rosidl_typesupport_cpp::PositionCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, uav_msgs, msg, PositionCmd)() {
  return get_message_type_support_handle<uav_msgs::msg::PositionCmd>();
}
